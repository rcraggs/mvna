...
import multiValuedNominalAlpha.MultiValuedAlphaCalculator;
...
import multiValuedNominalAlpha.reliabilityDataFactory.ReliabilityDataFactory;
 ...
 public class Console extends JFrame
 {
   ...
   final String LAST_OPENED_DATA = "lastOpened";
   private final String OTHER_TEXT = "Other";
   private int messageCount = 0;
   private String fileBasename;
   private String fileSeperator = System.getProperty("file.separator");
 
   private final String CONSOLE_TITLE = "Multiple Valued Nominal Alpha";
   private final String ROW_FOR_CODER_TEXT = "Rows for Coders";
   private final String LOAD_ERROR_MESSAGE = "Error creating reliability data matrix:";
   private final String GOOD_RDM_MESSAGE = "Valid reliability data loaded.";
   private final String ALPHA_FORMAT_STRING = "#.###";
 
   private final int TAB_RDM = 0;
   private final int TAB_COIN_MATRIX = 1;
   private final int TAB_OBS_DELTA = 2;
   private final int TAB_RESULTS = 3;
   private final int TAB_CALCULATIONS = 4;
   private boolean deCalculated;
   private boolean doCalculated;
   private boolean lastChangeWasValid;
   private boolean logStateWhenCalculated;
     ...
     try
     {
       ...
       this.openFile.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent evt) {
           Console.this.openFileActionPerformed(evt);
         }
       });
       ...
       this.expButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent evt) {
           Console.this.expButtonActionPerformed(evt);
         }
       });
       ...
       this.openFileMenuItem.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent evt) {
           Console.this.openFileMenuItemActionPerformed(evt);
         }
       });
   ...
   protected ReliabilityDataFileAndFormat getDataFileAndFormat()
   {
     ...
     String filepath = this.rdmFile.getParent();
     String name = this.rdmFile.getAbsolutePath();
   ...
   private void displayErrorMessage()
   {
     ...
     this.errorArea.append("The reliability data can not be parsed.\n");
     this.errorArea.append("The following errors were reported.\n\n");
     this.errorArea.append(this.errorMessages);
 
     this.rdmPanel.add(this.errorArea, "Center");
     this.rdmPanel.setVisible(true);
     ...
     if (this.rdmFile != null)
     {
       ...
       else
       {
         try {
           ...
           this.logStateWhenCalculated = this.logCalculations.isSelected();
   ...
   private void calculateDoAndUpdate()
   {
     if (this.rdm != null)
     {
       ...
       this.lastValidFileFormat = getDataFileAndFormat();
     }
   }
   ...
   protected void rowSpinnerStateChanged(ChangeEvent evt)
   {
     ...
     updateRDM(getDataFileAndFormat());
   }
   ...
   protected void valComboActionPerformed(ActionEvent evt)
   {
     ...
     try
     {
       dataFileAndFormat = getDataFileAndFormat();
     }
   ...
   protected void tabbedPaneStateChanged(ChangeEvent evt)
   {
     try {
       if ((this.rdm == null) && (this.tabbedPane.getSelectedIndex() != 0)) {
         this.tabbedPane.setSelectedIndex(0);
         printMessage("You need to load some valid reliability data.");
       }
       else if ((this.tabbedPane.getSelectedIndex() == 1) || ((this.tabbedPane.getSelectedIndex() == 2) && (!this.doCalculated)))
       {
         this.mvnaCalculator.calculateDo();
         setupDoDetails();
       }
   ...
   protected void obsButtonActionPerformed(ActionEvent evt)
   {
   ...
   private void openNewRDMFile()
   {
     ...
     if (fileDialogResult == 0) {
       this.rdmFile = fileChooser.getSelectedFile();
       setDefaultValues();
       this.lastDataFormat = getDataFileAndFormat();
