...
public class UISettings {
    ...
    public static final UISettings DEFAULT = new UISettings("", "", ',', '|', 1, 1, false, true);

    public UISettings(String path) throws IOException {
    ...
    public UISettings(String name, String path, char unitSep, char valSep, int row, int col, boolean log, boolean rowCoders) {
        this.filename = name;
        this.filepath = path;
        this.fromRow = row;
        this.fromCol = col;
